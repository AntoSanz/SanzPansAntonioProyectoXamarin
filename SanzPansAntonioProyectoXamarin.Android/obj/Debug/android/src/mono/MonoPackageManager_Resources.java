...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "SanzPansAntonioProyectoXamarin.Android.dll" comes first in this list. */
		"SanzPansAntonioProyectoXamarin.Android.dll",
		"FormsViewGroup.dll",
		"SanzPansAntonioProyectoXamarin.dll",
